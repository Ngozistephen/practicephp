        ...
        <div id="content">
            ...
            <?php
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') { 
                    ...
                    // Make the query , user_id is auto increment so it is omitted 
            ...
            <form action="register-page.php" method="post">
                ...
                <p><label class="label" for="psword1">Password:</label>
                    <input id="psword1" type="password" name="psword1" size="12" maxlength="12" value="<?php if (isset($_POST['psword1'])) echo $_POST['psword1']; ?>">&nbsp; Between 8 and 12 characters.</p>
